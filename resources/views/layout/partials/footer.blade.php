    ...
    <div class="footer-copyright copyrights-layout-default">
        <div class="container">
            <div class="copyright-inner">
                <div class="copyright-cell"> &copy; 2020 <span class="highlight">StemForSuperGirls</span>. Created by StemForSuperGirls Team.</div>
                <div class="copyright-cell">
                    <ul class="studiare-social-links">
                        <li><a href="https://www.facebook.com/STEMforSuperGirls" class="facebook"><i class="fa fa-facebook-f"></i></a></li>
