...
@section('content')
    <div class="col-12 mt-4">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="mt-2 mb-2">All Competition Mentors</h4>
                <div class="table-responsive">
                    <table id="example1" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    {{$competitionmentor->competition->program->title}}
                                </td>
                                <td>
                                    {{$competitionmentor->competition->title}} 
                                </td>
                                <td>
                                    {{$competitionmentor->name}} 
                                </td>
                                <td>
                                    <img src="{{asset('storage/competition/mentors/'.$competitionmentor->image)}}" style="width: 60px; height: 60px;" alt="" srcset="">
                                </td>
                                <td>
                                  <a href="{{route('competition.mentor.edit',$competitionmentor->id)}}" class="btn btn-xs btn-info"><i class="fa fa-pencil"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
